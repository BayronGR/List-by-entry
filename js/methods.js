async function getGroups() {
  try {
    const scriptUrl = 'https://script.google.com/macros/s/AKfycbwuJFdUKkfv9UutPu2lk81LVQ_eJf6qOcycprbvrBNS33KKed9YTkvB4afFGk58jh93/exec';
...
async function getCounts() {
  try {
    const scriptUrl = 'https://script.google.com/macros/s/AKfycbzXM50CgOGZdOMNVonQrZEuaqcj91TQsSPKTfJqNntD31Q7eCISh1BvTQ0aucXfeODi/exec';
    const response = await fetch(scriptUrl);
...
async function updateDateById(id) {
  try {
    ...
    const scriptUrl = 'https://script.google.com/macros/s/AKfycby8V-uxWiJMRPi-GPmDQzWnIpf-m_dVYCKax2RYg71DO679M1sxCb5c5lTNKjUNHocA/exec';
